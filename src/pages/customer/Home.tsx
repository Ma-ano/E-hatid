  ...
  return (
    <>
      ...
      <div className="pb-2 sm:pb-3">
        ...
        {/* Location */}
        {isAuthenticated && (
          <div className="flex items-center gap-2 py-2 sm:py-3 cursor-pointer hover:opacity-80" onClick={() => history.push('/customer/profile')}>
          ...
          <div className="flex gap-2 bg-[var(--tw-light)] dark:bg-[#1E293B] p-1 rounded-full w-full">
            {categories.map((cat) => (
              ...
              >
                ...
                <span className={`relative z-10 block truncate ${selectedCategory === cat ? "text-white" : "text-[var(--tw-text-secondary)] dark:text-gray-300"}`}>
                  {cat}
                </span>
              </button>
            ))}
        ...
        {/* Main Content */}
        <div className="py-2 sm:py-4 min-h-[400px] flex flex-col">
