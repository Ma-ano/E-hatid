...
const sidebarItems = [
  { label: 'Dashboard', icon: appsOutline, activeIcon: apps, path: '/admin/dashboard' },
  { label: 'Users', icon: peopleOutline, activeIcon: people, path: '/admin/users' },
  { label: 'Riders', icon: bicycleOutline, activeIcon: bicycle, path: '/admin/riders' },
  { label: 'Orders', icon: documentTextOutline, activeIcon: documentText, path: '/admin/orders' },
  { label: 'Reports', icon: barChartOutline, activeIcon: barChart, path: '/admin/reports' },
];
        ...
        <div className="flex min-h-full">
          ...
          >
            <div className="flex items-center justify-between p-4 border-b border-[var(--ion-border-color)]">
              <span className="text-lg font-bold text-[var(--ion-text-color)]">Admin</span>
              <button
                onClick={() => setSidebarOpen(false)}
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="sticky top-0 z-30 lg:hidden bg-[var(--ion-card-background)] border-b border-[var(--ion-border-color)]">
              <div className="flex items-center h-14 px-4">
                ...
                <span className="ml-2 text-base font-bold text-[var(--ion-text-color)]">Admin</span>
              </div>
            </div>
